...
EXP_06_DIR = ROOT / "experiments" / "experiment_06_fourier_series_parameter_sensitivity"
...
def main() -> int:
    ...
    if args.exp == "6":
        return run_python_script(EXP_06_DIR, "main.py")

    if args.exp == "all":
        for exp_dir in (EXP_01_DIR, EXP_02_DIR, EXP_03_DIR, EXP_04_DIR, EXP_05_DIR, EXP_06_DIR):
